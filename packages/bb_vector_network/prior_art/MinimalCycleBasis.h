...
namespace gte
{
    ...
    public:
            ...
            std::vector<std::shared_ptr<Tree>>& forest)
        {
            ...
            // Hashmap of all unique positions referenced by the edges.
            // Stores <VertexIndex, VertexPosition>
    ...
    private:
        ...
        // Filaments are used to describe paths of the graph that do not close, i.e. a dead end.
