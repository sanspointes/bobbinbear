...
//   return event.index + event.instanceId
// }
//
// /**
...
//   obj: Container,
//   captures: Map<Container, PointerCaptureTarget>,
//   pointerId: number,
// ): void {
...
// }
//
// export function removeInteractivity(state: RootState, object: Container) {
...
//   function filterPointerEvents(objects: Container[]) {
//     return objects.filter((obj) =>
//       ['Move', 'Over', 'Enter', 'Out', 'Leave'].some(
//         (name) =>
//           (obj as Instance<Container>['object']).__r3f?.handlers[('onPointer' + name) as keyof EventHandlers],
//       ),
//     )
//   }
//
//   function intersect(event: DomEvent, filter?: (objects: Container[]) => Container[]) {
...
//     }
//
//     function handleRaycast(obj: Container) {
...
//
//     // Collect events
//     let hits: THREE.Intersection<Container<THREE.Event>>[] = eventsObjects
//       // Intersect objects
...
//       let eventObject: Container | null = hit.object
//       // Bubble event up
//       while (eventObject) {
//         if ((eventObject as Instance<Container>['object']).__r3f?.eventCount)
...
//         if (state) {
//           const { raycaster, pointer, internal } = state
...
//         const instance = (eventObject as Instance<Container>['object']).__r3f
...
//   }
//
//   function pointerMissed(event: MouseEvent, objects: Container[]) {
//     for (let i = 0; i < objects.length; i++) {
//       const instance = (objects[i] as Instance<Container>['object']).__r3f
