...
type ConstructableRenderer<TContext extends object> = {
  ...
  createRoot: <TRootObject extends Constructable>(rootObject: InstanceType<TRootObject> | Accessor<InstanceType<TRootObject>>, context: TContext) => SolixiRoot<TContext, SxiObjectMetadata<TContext, TRootObject>>,
  wrapConstructable: <
...
export const createRenderer = <TContext extends object>(context: Context<TContext>): ConstructableRenderer<TContext> => {
  ...
  return {
    ...
    createRoot: <TRootObject extends Constructable>(rootObject: InstanceType<TRootObject> | Accessor<InstanceType<TRootObject>>, initialState: TContext) => {
