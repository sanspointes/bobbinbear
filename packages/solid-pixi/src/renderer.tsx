...
import { createPixiRenderer as createPixiRenderer } from "./core/renderer";
import { roots } from "./core";
import { createSolidRenderer } from "./solid";

export const pixiReconciler = createPixiRenderer(roots);
export const threeRenderer = createSolidRenderer(pixiReconciler);
