...
import { BiRegularPen, BiRegularText } from 'solid-icons/bi';
        ...
        <div class="flex justify-between p-2 bg-orange-500 border-b border-orange-700 border-solid">
            <div class="flex items-center gap-2">
                ...
                <Button
                    ...
                    classList={{
                        'outline outline-2 outline-orange-700':
                            toolStore.tool === Tool.Pen,
                    }}
                    highlighted={toolStore.tool === Tool.Pen}
                ...
                <Button
                    ...
                    classList={{
                        'outline outline-2 outline-orange-700':
                            toolStore.tool === Tool.Text,
                    }}
                    highlighted={toolStore.tool === Tool.Text}
                    onClick={() => dispatch('tool:switch', Tool.Text)}
                >
                    <BiRegularText class="fill-orange-800 w-[22px] h-[22px]" />
                </Button>
            </div>
