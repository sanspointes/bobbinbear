...
export type AttributeGraphicsEntry = {
  [K: AttributeGraphicsEntryKey]: number | [x: number, y: number] | [
    x: number,
    y: number,
    z: number,
  ];
 ...
 * polygon line.
 */
export class AttributeGraphics<TAttributes extends AttributeGraphicsEntry>
  extends Graphics {
  ...
  moveTo(x: number, y: number): this {
    ...
    if (this.currentAttributes) this.attributeData.push(this.currentAttributes);
