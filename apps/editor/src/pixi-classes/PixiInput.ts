...
import { GeometryText } from '@bearbroidery/pixi-geometry-text';

// TODO: Maybe upstream these changes
// TODO: Replace typed signals with internal implementation
 ...
 * });
 */
export class PixiInput extends Container {
    ...
    constructor(options: InputOptions) {
        ...
        this._cursor.tint = options.textStyle?.fill
            ? Number(options.textStyle.fill)
            : 0x000000;
