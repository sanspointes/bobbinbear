...
const button = tv({
    ...
    variants: {
        variant: {
            default:
                'bg-orange-200 hover:bg-orange-100 text-orange-800 font-bold',
            secondary:
                'bg-orange-200 bg-opacity-0 border-orange-600 border-solid border text-orange-800 hover:bg-opacity-20',
        },
        link: {
            true: 'bg-transparent',
        },
