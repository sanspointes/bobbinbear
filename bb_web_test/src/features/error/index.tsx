                ...
                >
                    ...
                    <p class="mb-6 w-full text-orange-200">
                        <span class="line-through">
                            Help me out! Please consider reporting the error so
                            I can fix it.
                        </span>{' '}
                        <br /> I don't have error reporting set up yet. Just hit
                        the reload button.
                    </p>
                ...
                <Show when={showExtra()}>
                    <div class="flex absolute bottom-6 left-1/2 flex-col gap-2 items-start py-4 w-full text-sm bg-orange-900 -translate-x-1/2 max-h-[80vh]">
                        ...
                        <p class="mb-6 text-orange-200">
                            We send the following error data and where it came
